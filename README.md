...
The master table must be in CSV format, with a coma ',' as a separator. It must contain at least 2 columns:
...
An interactive window will pop, that will allow you to navigate through the extracted tiles.
